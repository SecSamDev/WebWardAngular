...
import { WebProjectEditComponent,WebProjectPageComponent,WebProjectComponent } from './web-project/index';
...
const routes: Routes = [
  ...
  { path: 'reports', component: ScanReportComponent, canActivate: [AuthGuard] },
  { path: 'reports/:id', component: FullReportViewComponent, canActivate: [AuthGuard] },
